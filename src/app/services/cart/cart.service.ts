...
export class CartService {
  ...
  alertClearCart(index, items, data, order?) {
    this.global.showAlert(
      order ? 
      '¿Le gustaría restablecer su carrito antes de volver a hacer un pedido en este restaurante?' 
      : 
      'Su carrito contiene artículos de un restaurante diferente. ¿Te gustaría reiniciar tu carrito antes de navegar por el restaurante?',
