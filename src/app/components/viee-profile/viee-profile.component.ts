...
@Component({
  selector: 'app-viee-profile',
  templateUrl: './viee-profile.component.html',
  styleUrls: ['./viee-profile.component.scss'],
})
export class VieeProfileComponent  implements OnInit {
